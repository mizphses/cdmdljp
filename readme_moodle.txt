...
* remove folder theme/cdmdljp/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/cdmdljp/scss/bootstrap
...
* comment out this line in theme/cdmdljp/scss/_print.scss
    @page {
...
* copy the js files from ~/bootstrap/js/src to theme/cdmdljp/amd/src/bootstrap (including the subfolder)
...
* in folder theme/cdmdljp run "Grunt amd" to compile the bootstrap JS
